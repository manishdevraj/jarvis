 ...
 * even elements, bordered either by either end of the list or an odd element. For example, if the list is
 * [1, 2, 8, 9, 12, 16], the subparts of the list are [2, 8] and [12, 16].
 * Then, for each subpart, the order of the elements is reversed. In the example, this would result in the
...
public class ReverseOperations {
    ...
    // reverse all even elements and make next last even element is new a head and point original
