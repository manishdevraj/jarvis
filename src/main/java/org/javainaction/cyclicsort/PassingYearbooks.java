 ...
 * Initially, each student is holding their own yearbook. The students will then repeat the following two steps
 * each minute: Each student i will first sign the yearbook that they're currently holding
 ...
 * Once a student has received their own yearbook back, they will hold on to it and no longer participate in
 * the passing process.
