...
public class RunLengthEncoding3 {
    public static int compress(char[] chars) {
        ...
        while (left < chars.length) {
            //slide window until char is same
            while(right < chars.length && chars[left] == chars[right]) right++;

            //length of window would be frequency
            int frequency = right - left;
    ...
    public static void main(String[] args){
        ...
        System.out.println("Compressed into " + compress(input1));

        char[] input2 = new char[]{'a','b','b','b','b','b','b','b','b','b','b','b','b'};
        System.out.println("Compressed into " + compress(input2));
