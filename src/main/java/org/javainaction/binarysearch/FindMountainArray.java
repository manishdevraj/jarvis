...
public class FindMountainArray {
    public int findInMountainArray(int target, MountainArray mountainArr) {
        //because the order is ascending and then descending from peak we cannot use standard binary array
        //we need to first find the peak and then search on either side of the pic to get the element index
