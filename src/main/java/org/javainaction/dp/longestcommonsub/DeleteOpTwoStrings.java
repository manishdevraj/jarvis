...
public class DeleteOpTwoStrings {
    ...
    public static int minDistance(String s1, String s2) {
        ...
        //similar to longest common subsequence we are not looking at exact match
        //we add 1 to previous letter position's strict match or
        //we try to see if we delete current letter in either of string which gives us maximum match count
